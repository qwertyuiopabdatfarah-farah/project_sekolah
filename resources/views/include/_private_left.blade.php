 <div class="sidebar-header">
    ...
    <div class="nano has-scrollbar">
        <div class="nano-content" tabindex="0" style="right: -16px;">
        ...
        <div class="nano-pane" style="opacity: 1; visibility: visible;"><div class="nano-slider" style="height: 51px; transform: translate(0px, 0px);"></div></div></div>
