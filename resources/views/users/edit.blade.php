...
<h2 class="panel-title">Edit User</h2>
     ...
     <div class="panel-body" style="display: block;">  
         ...
         {!! Form::model($user, ['method' => 'PATCH', 'class' => 'form-horizontal form-bordered','route' => ['users.update', $user->id]]) !!}
        ...
        <div class="form-group{{ $errors->has('roles') ? ' has-error' : '' }}">
          <label class="col-md-3 control-label">Roles User</label>
          <div class="col-md-6"> 
            {!! Form::select('roles[]', $roles,$userRole, ['multiple' => true, 'id'=>'example-filter-placeholder', 'class' => 'form-control mb-3']) !!}
            @if ($errors->has('roles'))
          <span class="help-block">
       ...
       <div class="form-group">
        ...
        <div class="col-md-6"> 
      {{ Form::button('<i class="fa fa-send fa-fw " aria-hidden="true"></i> Update ', ['type' => 'submit', 'class' => 'btn btn-outline custom-border-width btn-primary custom-border-radius font-weight-semibold text-uppercase mt-5 mb-3']) }}
